...
function buildOfficialProd(done) {
    buildApp({
        network: 'mainnet',
        decompileUrl: 'https://node.youngmarket.net/utils/script/decompile'
    }, 'prod', done);
}
...
function buildOfficialTestnet(done) {
    buildApp({
        network: 'testnet',
        decompileUrl: 'https://testnode1.youngmarket.net/utils/script/decompile'
    }, 'prod', done);
}
...
function buildOfficialStagenet(done) {
    buildApp({
        network: 'stagenet',
        decompileUrl: 'https://nodes-stagenet.youngmarket.net/utils/script/decompile'
    }, 'prod', done);
}
